...
fun_udp1 () {
    ...
    menu
	    ...
	    inst_udp () {
            ...
            wget https://raw.githubusercontent.com/mauvadao4g/ssh_projetos/main/MEGA/badvpn/badvpn-udpgw -o /dev/null
			wget https://raw.githubusercontent.com/mauvadao4g/ssh_projetos/main/MEGA/badvpn/antcrashvpn.sh -o /dev/null
